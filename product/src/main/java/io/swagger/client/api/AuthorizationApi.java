...
public class AuthorizationApi {
     ...
     */
    public com.squareup.okhttp.Call rolesPostCall(String apiToken, JsonData jsonData, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call rolesPostValidateBeforeCall(String apiToken, JsonData jsonData, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        if (jsonData == null) {
            throw new ApiException("Missing the required parameter 'jsonData' when calling rolesPost(Async)");
        }
        

        com.squareup.okhttp.Call call = rolesPostCall(apiToken, jsonData, progressListener, progressRequestListener);
        return call;
     ...
     */
    public void rolesPost(String apiToken, JsonData jsonData) throws ApiException {
        rolesPostWithHttpInfo(apiToken, jsonData);
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Void> rolesPostWithHttpInfo(String apiToken, JsonData jsonData) throws ApiException {
        com.squareup.okhttp.Call call = rolesPostValidateBeforeCall(apiToken, jsonData, null, null);
     ...
     */
    public com.squareup.okhttp.Call rolesPostAsync(String apiToken, JsonData jsonData, final ApiCallback<Void> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = rolesPostValidateBeforeCall(apiToken, jsonData, progressListener, progressRequestListener);
