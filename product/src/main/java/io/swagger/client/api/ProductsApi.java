...
public class ProductsApi {
     ...
     */
    public com.squareup.okhttp.Call productsGetCall(String apiToken, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call productsGetValidateBeforeCall(String apiToken, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = productsGetCall(apiToken, progressListener, progressRequestListener);
        return call;
     ...
     */
    public List<ProductShort> productsGet(String apiToken) throws ApiException {
        ApiResponse<List<ProductShort>> resp = productsGetWithHttpInfo(apiToken);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<List<ProductShort>> productsGetWithHttpInfo(String apiToken) throws ApiException {
        com.squareup.okhttp.Call call = productsGetValidateBeforeCall(apiToken, null, null);
     ...
     */
    public com.squareup.okhttp.Call productsGetAsync(String apiToken, final ApiCallback<List<ProductShort>> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = productsGetValidateBeforeCall(apiToken, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<List<ProductShort>>(){}.getType();
     ...
     * @param apiToken Authentication token (required)
     * @param jsonData JSON data that contains information to create new product (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call productsPostCall(String apiToken, CreateProduct jsonData, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call productsPostValidateBeforeCall(String apiToken, CreateProduct jsonData, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        if (jsonData == null) {
            throw new ApiException("Missing the required parameter 'jsonData' when calling productsPost(Async)");
        }
        

        com.squareup.okhttp.Call call = productsPostCall(apiToken, jsonData, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ProductShort productsPost(String apiToken, CreateProduct jsonData) throws ApiException {
        ApiResponse<ProductShort> resp = productsPostWithHttpInfo(apiToken, jsonData);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<ProductShort> productsPostWithHttpInfo(String apiToken, CreateProduct jsonData) throws ApiException {
        com.squareup.okhttp.Call call = productsPostValidateBeforeCall(apiToken, jsonData, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call productsPostAsync(String apiToken, CreateProduct jsonData, final ApiCallback<ProductShort> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = productsPostValidateBeforeCall(apiToken, jsonData, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<ProductShort>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @param apiToken Authentication token (required)
     * @param ref ID for product (required)
     * @param jsonData JSON data that contains product details to update (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call productsRefPutCall(String apiToken, String ref, UpdateProduct jsonData, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = jsonData;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call productsRefPutValidateBeforeCall(String apiToken, String ref, UpdateProduct jsonData, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // verify the required parameter 'jsonData' is set
        if (jsonData == null) {
            throw new ApiException("Missing the required parameter 'jsonData' when calling productsRefPut(Async)");
        }
        

        com.squareup.okhttp.Call call = productsRefPutCall(apiToken, ref, jsonData, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public void productsRefPut(String apiToken, String ref, UpdateProduct jsonData) throws ApiException {
        productsRefPutWithHttpInfo(apiToken, ref, jsonData);
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Void> productsRefPutWithHttpInfo(String apiToken, String ref, UpdateProduct jsonData) throws ApiException {
        com.squareup.okhttp.Call call = productsRefPutValidateBeforeCall(apiToken, ref, jsonData, null, null);
        return apiClient.execute(call);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call productsRefPutAsync(String apiToken, String ref, UpdateProduct jsonData, final ApiCallback<Void> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = productsRefPutValidateBeforeCall(apiToken, ref, jsonData, progressListener, progressRequestListener);
        apiClient.executeAsync(call, callback);
        return call;
    }
    /**
