...
public class ApiClient {
    ...
    private String basePath = "https://hsbc-dev.iriusrisk.com/api/v1";
    ...
    public ApiClient() {
        ...
        String proxyHost = System.getenv("proxy.host");
        if (proxyHost != null) {
            int proxyPort = Integer.parseInt(System.getenv("proxy.port"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://demo.iriusrisk.com/api/v1
